...
#include "cartographer_ros_msgs/SwitchTrajectory.h"
...
namespace cartographer_ros
{
    ...
    public:
        ...
        int StartTrajectoryIDWithDefaultTopics(const TrajectoryOptions &options);
        ...
        void HandleInitPoseMessage(int trajectory_id, const std::string &sensor_id,
    ...
    public:
        std::vector<Pbstream> pbstreams_;
    ...
    private:
        ...
        bool HandleSwitchTrajectory(::cartographer_ros_msgs::SwitchTrajectory::Request &request, ::cartographer_ros_msgs::SwitchTrajectory::Response &response);
